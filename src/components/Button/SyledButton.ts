...
function setAdditionalStyles(variant: Variant, isSuccess: boolean) {
    if (variant == 'Filled')
        return css`
            ...
            &:hover {
                background: ${({ theme }) =>
                    isSuccess ? theme.Button.colorHoverSuccess : theme.Button.colorHoverError};
            }
        `;
    if (variant == 'Text')
        return css`
            ...
            &:hover {
                ...
                background-color: ${({ theme }) =>
                    isSuccess ? theme.Button.colorHoverSuccess + '10' : theme.Button.colorHoverError + '10'};
            }
        `;
    return css`
        ...
        &:hover {
            background: ${({ theme }) =>
                isSuccess ? theme.Button.colorHoverSuccess + '06' : theme.Button.colorHoverError + '06'};
...
const ButtonStyle = css<StyledProps>`
    ${({ theme, shape, size, variant, icon }) => css`
        ...
        ${icon
            ? css`
                  padding: ${theme.Button['padding-1'] + 'rem'};
              `
            : css`
