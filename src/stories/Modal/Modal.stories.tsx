...
export default {
    ...
    argTypes: {
        ...
        onCancel: {
            description:
                'Callback функция. Принимает объект ивента Html элемента Button | Div. Срабатывает на нажатие кнопок: Cansel, X, Escape',
        },
        onConfirm: {
            description:
                'Callback функция. Принимает объект ивента Html элемента Button | Div. Срабатывает на нажатие кнопоки Confirm',
        },
        open: {
