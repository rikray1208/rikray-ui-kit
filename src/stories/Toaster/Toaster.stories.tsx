    ...
    return (
        <>
            ...
            <div style={{display: "flex", gap: '10px', flexDirection: 'column', alignItems: 'start'}}>
                <Button size={"Small"} variant={'Outline'} onClick={() => click('info')}>Base toast</Button>
                <Button size={"Small"} variant={'Outline'} onClick={() => click('success')}>Success toast</Button>
                <Button size={"Small"} variant={'Outline'} onClick={() => click('error')}>Error toast</Button>
                <Button size={"Small"} variant={'Outline'} onClick={() => click('warning')}>Warning toast</Button>
            </div>
        </>
    );
};
